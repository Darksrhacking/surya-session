            ...
            SURYA.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'SURYA-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';

                    console.log(`Session ID: ${sid}`);

                    const session = await SURYA.sendMessage(SURYA.user.id, { text: sid });
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of SURYA-MD.
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vb64JNKJf05UHKREBM1h) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Darksrhacking GitHub Repo](https://github.com/Darksrhacking/)  

🚀 _Thanks for choosing SURYA-MD — Let the automation begin!_ ✨`;

                    await SURYA.sendMessage(SURYA.user.id, { text: SURYA_TEXT }, { quoted: session });
